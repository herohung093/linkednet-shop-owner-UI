...
const PasswordResetPage: React.FC = () => {
	...
	const handlePasswordReset = async () => {
		...
		try {
			await axiosWithToken.put("/users", {
		...
		<div className="flex flex-col items-center justify-center min-h-screen">
			<div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md mx-3">
				...
				<button
					...
					className={`w-full flex justify-center items-center h-[40px] ${!isFormValid ? "bg-gray-400" : "bg-slate-900 hover:bg-slate-700"
			...
			{showSuccessPopup && (
				<div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
					<div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md mx-3">
						...
						<p className="text-center mb-4">Your password has been changed successfully.</p>
						<button
